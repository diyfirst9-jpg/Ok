...
typedef struct VkFrame {
    ...
    // Signaled by the REAL submission; FG consumes it from a separate submission.
    VkSemaphore framegen_ready;
    VkFence     in_flight;
    VkFence     framegen_in_flight;
    VkCommandBuffer cmd;
    VkCommandBuffer framegen_cmd;
} VkFrame;
