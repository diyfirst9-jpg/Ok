...
object EpicCloudSavesManager {
    ...
    private val activeSyncs = mutableSetOf<SyncScope>()
    ...
    suspend fun syncCloudSaves(
        ...
        withContext(Dispatchers.IO) {
            ...
            syncMutex.withLock {
                ...
                if (activeSyncs.contains(syncScope)) {
                    Timber.tag("Epic").w("[Cloud Saves] Sync already in progress for $syncScope, skipping duplicate request")
                    return@withContext uploadRequest
                }
                activeSyncs.add(syncScope)
            }
