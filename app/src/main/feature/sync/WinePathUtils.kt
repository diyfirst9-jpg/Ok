 ...
 * PathType.kt covers Steam/GOG/Epic forward mapping; this helper covers the missing reverse
 * direction (Android -> Windows) plus a forward resolver that goes through a specific Container.
 */
