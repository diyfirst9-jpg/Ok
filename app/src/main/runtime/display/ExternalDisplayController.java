...
public final class ExternalDisplayController {
    ...
    private int fillMode = ViewTransformation.FILL_MODE_NATIVE;
    ...
    public void enterSwap() {
        ...
        swapActive = true;
        renderActive = false;
        fillMode = ViewTransformation.FILL_MODE_NATIVE;
        rebuildModeTables();
    ...
    public void exitSwap() {
        ...
        if (renderer != null) {
            renderer.setFillModeQuiet(ViewTransformation.FILL_MODE_NATIVE);
